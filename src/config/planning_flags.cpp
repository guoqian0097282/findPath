...
DEFINE_double(car_length, 4.2, "");

DEFINE_double(safety_margin, 1.0, "mandatory safety margin");

DEFINE_double(wheel_base, 2.8, "wheel base");

DEFINE_double(rear_length, 1.0, "rear axle to rear edge");

DEFINE_double(front_length, 3.2, "rear axle to front edge");
...
DEFINE_double(search_lateral_range, 1.0, "max offset when searching");
...
DEFINE_double(search_deviation_cost, 0.6, "offset from the original ref cost");
/////
