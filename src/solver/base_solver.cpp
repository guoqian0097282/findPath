...
void BaseSolver::setConstraints(Eigen::SparseMatrix<double> *matrix_constraints,
    ...
    *upper_bound = Eigen::MatrixXd::Zero(cons_size_, 1);
    ...
    // End state.
    (*lower_bound)(end_state_idx) = -OsqpEigen::INFTY; //-OsqpEigen::INFTY; 1e+30
    (*upper_bound)(end_state_idx) = OsqpEigen::INFTY; //OsqpEigen::INFTY;
    (*lower_bound)(end_state_idx + 1) = 0.0;  
    (*upper_bound)(end_state_idx + 1) = 0.0;
...
void BaseSolver::getOptimizedPath(const Eigen::VectorXd &optimization_result,
    ...
    {
        std::cout<<"getOptimizedPath vars_size_ not equation optimization_result.size()"<<std::endl;
    }
